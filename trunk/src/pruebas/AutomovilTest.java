...
public class AutomovilTest {
	...
	public void testAutomovilConMotor_Lin64_YRuedas_Paler9() {
		metaAuto = new MetadataAuto(NombresDeFabricables.PALER9, NombresDeFabricables.LIN64);
	...
	public void testAutomovilConMotor_Lin64_YRuedas_Mess10() {
		metaAuto = new MetadataAuto(NombresDeFabricables.MESS10, NombresDeFabricables.LIN64);
		auto = FabricaDeAutos.instanciarAuto(metaAuto);
	...
	public void testAutomovilConMotor_MacX_YRuedas_Paler9() {
		metaAuto = new MetadataAuto(NombresDeFabricables.PALER9, NombresDeFabricables.MACX);
		auto = FabricaDeAutos.instanciarAuto(metaAuto);
		assertTrue(auto.neumaticos() == NombresDeFabricables.PALER9);
	...
	public void testAutomovilConMotor_MacX_YRuedas_Mess10() {
		metaAuto = new MetadataAuto(NombresDeFabricables.MESS10, NombresDeFabricables.MACX);
		auto = FabricaDeAutos.instanciarAuto(metaAuto);
		assertTrue(auto.neumaticos() == NombresDeFabricables.MESS10);
		assertTrue(auto.motor() == NombresDeFabricables.MACX);
	}
	...
	public void testAutomovilConMotor_Win32_YRuedas_Paler9() {
		metaAuto = new MetadataAuto(NombresDeFabricables.PALER9, NombresDeFabricables.WIN32);
		auto = FabricaDeAutos.instanciarAuto(metaAuto);
		assertTrue(auto.neumaticos() == NombresDeFabricables.PALER9);
	...
	public void testAutomovilConMotor_Win32_YRuedas_Mess10() {
		metaAuto = new MetadataAuto(NombresDeFabricables.MESS10, NombresDeFabricables.WIN32);
		auto = FabricaDeAutos.instanciarAuto(metaAuto);
		assertTrue(auto.neumaticos() == NombresDeFabricables.MESS10);
		assertTrue(auto.motor() == NombresDeFabricables.WIN32);
	}
	...
	@Test
	public void testGetPosicionReal() {
		fail("Not yet implemented");
	}
	...
	@Test
	public void testDoblarALaIzquierda() {
		fail("Not yet implemented");
	}

	@Test
	public void testDoblarALaDerecha() {
		fail("Not yet implemented");
	}
