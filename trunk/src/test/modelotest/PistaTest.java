...
public class PistaTest {
	...
	public void testIntentarAgregarNuevoTiempo() {
		...
		assertTrue(unaPista.getListaDeMejoresTiempos().getFirst().getNombre()
				.equals("Jugador2"));
		assertTrue(unaPista.getListaDeMejoresTiempos().getFirst().getTiempo() == 60);
		assertTrue(unaPista.getListaDeMejoresTiempos().get(1).getNombre()
				.equals("Jugador1"));
	...
	public void testCargarDesdeXML() {
		...
		assertTrue(unaPista.getListaDePozos().getFirst()
				.posicionEsquinaInferiorIzquierda().x() == 1);
		assertTrue(unaPista.getListaDePozos().getFirst()
				.posicionEsquinaInferiorIzquierda().y() == 120);
		assertTrue(unaPista.getListaDeLomasDeBurro().getFirst()
				.posicionEsquinaInferiorIzquierda().x() == 1);
		assertTrue(unaPista.getListaDeLomasDeBurro().getFirst()
				.posicionEsquinaInferiorIzquierda().y() == 300);
		assertTrue(unaPista.getListaDeMejoresTiempos().getFirst().getNombre()
				.equals("Jugador1"));
	...
	public void testGetLargo() {
		...
		assertTrue(unaPista.getLargo() == 1000);
	}
	...
	public void testGetListaDeLomasDeBurro() {
		unaPista.getListaDeLomasDeBurro().getFirst()
				.equals(new LomaDeBurro(1, 1200, 6));
	...
	public void testGetListaDeTerrenos() {
		try {
			unaPista.getListaDeTerrenos().getFirst()
					.equals(new Asfalto(0, 4000));
	...
	/*
	 * 
	 * @Test public void testAleatoria() { fail("Not yet implemented"); }
	 */
