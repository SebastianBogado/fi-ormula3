...
public class LomaDeBurroTest extends TestCase {
	...
	public void testDeserializarXML() throws ExcepcionLimitesIncorrectosEnElTerreno{
		...
		try {
			...
			assertTrue(otraLomaDeBurro.posicionEsquinaInferiorIzquierda().x()==loma.posicionEsquinaInferiorIzquierda().x());
			assertTrue(otraLomaDeBurro.posicionEsquinaInferiorIzquierda().y()==loma.posicionEsquinaInferiorIzquierda().y());
