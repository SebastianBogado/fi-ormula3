...
public class PozoTest extends TestCase {
	...
	public void testDeserializarXML() throws ExcepcionLimitesIncorrectosEnElTerreno{
		...
		try {
			...
			assertTrue(otroPozo.posicionEsquinaInferiorIzquierda().x()==pozo.posicionEsquinaInferiorIzquierda().x());
			assertTrue(otroPozo.posicionEsquinaInferiorIzquierda().y()==pozo.posicionEsquinaInferiorIzquierda().y());
